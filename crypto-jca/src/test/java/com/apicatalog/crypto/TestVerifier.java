...
class TestVerifier {
    ...
    void testVerify(String algo, String pk, String data, String signature) throws Throwable {

        var verifier = JcaAsymmetricVerifier.getInstance(algo);
    ...
    static final Stream<Arguments> resources() throws TreeIOException {
        return Stream.of(
                Arguments.of(
                        "P-256",
