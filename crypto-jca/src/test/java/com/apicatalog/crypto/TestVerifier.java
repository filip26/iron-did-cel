...
import com.apicatalog.crypto.jca.JcaAsymmetricVerifier;
...
class TestVerifier {
    ...
    void testP256_1() throws Throwable {
        ...
        var verifier = JcaAsymmetricVerifier.getInstance("P-256");
    ...
    void testP384_1() throws Throwable {
        ...
        var verifier = JcaAsymmetricVerifier.getInstance("P-384");
        assertNotNull(verifier);
    ...
    void testEd25519_1() throws Throwable {
        ...
        var verifier = JcaAsymmetricVerifier.getInstance("Ed25519");
        assertNotNull(verifier);
