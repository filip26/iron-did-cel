...
public class CloudKMSSigner implements AsymetricSigner{
    ...
    /**
     * Creates a new {@link CloudKMSSigner} instance for the specified KMS algorithm
     */
    public static CloudKMSSigner getInstance(
            PublicKey publicKey,
            KeyManagementServiceClient kms) {

        return switch (publicKey.getAlgorithm()) {
        case EC_SIGN_P256_SHA256 -> new CloudKMSSigner(
                "ecdsa-jcs-2019",
                32,
                CloudKMSSigner::ec256Sign,
                kms,
                publicKey.getName(),
                "SHA-256",
                Multibase.BASE_58_BTC::encode);

        case EC_SIGN_P384_SHA384 -> new CloudKMSSigner(
                "ecdsa-jcs-2019",
                48,
                CloudKMSSigner::ec384Sign,
                kms,
                publicKey.getName(),
                "SHA-384",
                Multibase.BASE_58_BTC::encode);

        case EC_SIGN_ED25519 -> new CloudKMSSigner(
                "eddsa-jcs-2022",
                32,
                CloudKMSSigner::ed256Sign,
                kms,
                publicKey.getName(),
                "SHA-256",
                Multibase.BASE_58_BTC::encode);
        ...
        // PQ experiments
        case PQ_SIGN_SLH_DSA_SHA2_128S -> new CloudKMSSigner(
                "slhdsa128-jcs-2024",
                32,
                CloudKMSSigner::dsaSign,
                kms,
                publicKey.getName(),
                "SHA-256",
                Multibase.BASE_64_URL::encode);

        case PQ_SIGN_ML_DSA_44 -> new CloudKMSSigner(
                "mldsa44-jcs-2024",
                1312,
                CloudKMSSigner::dsaSign,
                kms,
        ...
        case PQ_SIGN_ML_DSA_87 -> new CloudKMSSigner(
                "mldsa87-jcs-2024",
                2592,
                CloudKMSSigner::dsaSign,
                kms,
